...
const IndexPage = () => {
  const data = useStaticQuery(graphql`
    query {
      ...
      nowymiot: file(relativePath: { eq: "2021/2.jpg" }) {
        childImageSharp {
          fluid(maxWidth: 900) {
            ...GatsbyImageSharpFluid_noBase64
          }
  ...
  return (
    <Layout>
      ...
      <main>
        <StyledContent>
          <img src={Paws} className="__paws" alt="" />
          <StyledRow>
            <StyledParagraph className="textAlignRight">
              ...
              <br />
              <Button to="/contact">Skontaktuj się z nami!</Button>
            </StyledParagraph>
          </StyledRow>
        </StyledContent>
        <hr />
        ...
        <DogShow></DogShow>
        <StyledContent>
          <img src={Paws} className="__paws reversed" alt="" />
          <StyledRow>
            <StyledParagraph>
          ...
          <StyledRow>
            <StyledParagraph>
              ...
              <span className="indented">
                ...
                <br />W Stanach Zjednoczonych pierwsze lhasa apso pojawiły się w
